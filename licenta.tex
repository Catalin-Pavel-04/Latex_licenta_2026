...
Tabelul \ref{tab:rezultate-categorii-qa1000} detaliază rata de trecere pentru fiecare categorie de întrebări, astfel încât performanța sistemului să poată fi analizată în funcție de tipul de nevoie informațională.
...
\label{tab:rezultate-categorii-qa1000}
\end{table}

Figura \ref{fig:qa1000-rata-trecere-categorii} reprezintă grafic aceleași rezultate pe categorii, pentru a evidenția mai rapid diferențele dintre categoriile cu performanță ridicată și cele problematice.
...
Tabelul \ref{tab:latenta-benchmark-independent} prezintă valorile agregate ale latenței observate în benchmark, utile pentru interpretarea performanței operaționale a aplicației în regim local.
