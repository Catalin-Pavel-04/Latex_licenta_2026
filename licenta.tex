...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{imagini/site_uvt.png}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|l|X|X|X|}
        ...
        Instrument AI & Scopul utilizării & Secțiuni în care a fost utilizat & Observații \\
        \hline
        OpenAI Codex / ChatGPT & Sprijin pentru alinierea structurii LaTeX la template-ul facultății și pentru verificarea compilării & Copertă, declarație de integritate științifică, bibliografie și anexe & Rezultatul a fost verificat prin compilare locală; instrumentul nu este tratat ca sursă bibliografică. \\
        \hline
    \end{tabularx}
...
Instrumentul a fost utilizat pentru reorganizarea documentului LaTeX conform template-ului oficial, fără introducerea unor surse bibliografice noi și fără modificarea argumentației tehnice a lucrării. Verificarea rezultatului s-a făcut prin inspectarea diferențelor și prin compilarea documentului.
